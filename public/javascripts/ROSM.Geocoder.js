ROSM.Geocoder = {
  call: function(gui_id, marker_id, query, callback) {
    ...
    //var call = ROSM.DEFAULTS.HOST_GEOCODER_URL + "json" + "?address=" + query + "&sensor=false" + "&key=" + AIzaSyC3aeY6RPu35aJQ5z3KInmv_l9W_A-pIuA;
    var call = ROSM.DEFAULTS.HOST_GEOCODER_URL + "?format=json" + "&limit=30&q=" + query;
    //var call = ROSM.DEFAULTS.HOST_GEOCODER_URL;

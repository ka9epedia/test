...
ROSM.GUI = {
  init: function() {
    ...
    document.getElementById("recommend").onclick = function() {ROSM.GUI.showRecommendFunction();};
  ...
  showRouteFunction: function() {
    ...
    $('#recommendFunction').css({left: 0 - $('#recommendFunction').width()});
  ...
  showRecommendFunction: function() {
    var r = 0;
    var s = 0;
    if($('#recommendFunction').position().left === $('#leftPanel').width()) {
      r = 0 - $('#recommendFunction').width();
      s = $(window).width() - $('#leftPanel').width();
    } else {
      r = $('#leftPanel').width();
      s = $(window).width() - $('#leftPanel').width() - $('#recommendFunction').width();
    }
    $('#routingFunction').css({left: 0 - $('#routingFunction').width()});
    $('#searchFunction').css({left: 0 - $('#searchFunction').width()});
    $('#poiFunction').css({left: 0 - $('#poiFunction').width()});
    $('#recommendFunction').stop().animate({left: r+'px'}, 300, function(){});
    $('#map').css({width: s});
  },
